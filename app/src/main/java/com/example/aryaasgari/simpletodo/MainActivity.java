...
public class MainActivity extends AppCompatActivity implements TodoAdapter.onTodoCheckedChangeListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //toast simple note to user about how app has interpreted their input
    ...
    public void onTodoCheckedChanged(String todo, boolean b){
        ...
        String completedState = b ? "COMPLETED" : "MARKED INCOMPLETE"; //ternary operator
